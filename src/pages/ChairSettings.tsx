...
export default function ChairSettings() {
  const { form, loading, saving, toast, loadError, handleSave, handleCancel, field } =
    useRoleUserProfileSettings('chair');
            ...
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.875rem' }}>
                <button onClick={handleSave} disabled={saving}
                  style={{ padding: '0.8rem', backgroundColor: saving ? '#9ca3af' : '#002147', color: 'white', border: 'none', borderRadius: '0.5rem', fontSize: '0.9rem', fontWeight: '600', cursor: saving ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}
                ...
                <button onClick={handleCancel} disabled={saving}
                  style={{ padding: '0.8rem', backgroundColor: '#e5e7eb', color: '#374151', border: 'none', borderRadius: '0.5rem', fontSize: '0.9rem', fontWeight: '500', cursor: saving ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}>
                  Cancel
                </button>
              </div>
            </>
