...
import { LayoutDashboard, FileText, Users, ListChecks, CalendarClock, Settings, LogOut, UserCircle } from 'lucide-react';

const NAV_ITEMS = [
  { label: 'Dashboard', path: '/hr/dashboard', Icon: LayoutDashboard },
  { label: 'Requisitions', path: '/hr/requisitions', Icon: FileText },
  { label: 'Candidate Management', path: '/hr/candidate-management', Icon: Users },
  { label: 'Shortlist Builder', path: '/hr/shortlist-builder', Icon: ListChecks },
  { label: 'Interview Scheduling', path: '/hr/interview-scheduling', Icon: CalendarClock },
...
export function HRLayout({ children }: { children: ReactNode }) {
  ...
  const displayName = getSession()?.fullName ?? 'Sarah Williams';
        ...
        <header style={{ height: '64px', backgroundColor: 'white', borderBottom: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', padding: '0 1.5rem', gap: '1.25rem', flexShrink: 0 }}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.72rem', color: '#FF6C37', fontWeight: '500' }}>HR Manager</div>
            </div>
          </div>
        </header>
